 ...
 * @author Andree
 */
public class Desplegar_Mensaje implements Instruccion {

    Instruccion contenido;
    LinkedList<Operacion> parametros;
    int line, column;

    public Desplegar_Mensaje(Instruccion contenido, int line, int column) {
    ...
    public Desplegar_Mensaje(Instruccion contenido, LinkedList<Operacion> parametros, int line, int column) {
        this.contenido = contenido;
    ...
    public Object Ejecutar(TablaDeSimbolos ts) {
        ...
        if ((cadena.length - 1) == parametros.size()) {
            if (cadena.length == 1) {
                ...
                JOptionPane.showMessageDialog(Principal.ventana_actual, palabra);
                return null;
            } else {
                char letra;
                ...
                JOptionPane.showMessageDialog(Principal.ventana_actual, salida);
                salida = "";
                return null;
            }
        }
